...
-- *****************************************************************************
-- Generated on "12/09/2020 21:53:08"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          Encoder_checker
-- 
...
ENTITY Encoder_checker_vhd_vec_tst IS
END Encoder_checker_vhd_vec_tst;
ARCHITECTURE Encoder_checker_arch OF Encoder_checker_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
